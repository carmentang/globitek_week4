...
if(is_post_request() && request_is_same_domain()) {
  ...
  if(isset($_POST['password']) && !is_blank($_POST['password'])) { $user['password'] = $_POST['password']; }
  if(isset($_POST['password_confirmation']) && !is_blank($_POST['password'])) { $user['password_confirmation'] = $_POST['password_confirmation']; }
...
<div id="main-content">
  ...
  <form action="edit.php?id=<?php echo h(u($user['id'])); ?>" method="post">
    ...
    <p>
      <i>Passwords should be at least 12 characters and include at least one uppercase letter, lowercase letter, number, and symbol.</i><br />
      Strong Password Suggestion: <?php echo generate_strong_password(); ?> <br />
    </p>
    <br />
