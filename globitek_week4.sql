...
# Generation Time: 2016-06-30 20:08:37 +0000
# ************************************************************
...
INSERT INTO `failed_logins` (`id`, `username`, `count`, `last_attempt`)
VALUES
	(1,'carmentang',1,'2016-06-30 12:55:40'),
	(5,'jmonroe99',0,'2016-06-30 12:19:39'),
	(6,'tackily',2,'2016-06-29 09:24:53'),
	(7,'connietang',5,'2016-06-29 09:36:53'),
	(8,'hannabanana',1,'2016-06-29 09:37:11'),
	(9,'taytaymont',0,'2016-06-30 12:56:03'),
	(10,'angieyang',0,'2016-06-30 11:17:46'),
	(11,'jayjaylau',2,'2016-06-30 12:17:10'),
	(12,'obama_out',0,'2016-06-30 12:58:18');
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `username`, `created_at`, `hashed_password`)
VALUES
	(4,'Taylor','Montgomery','taylormont@fb.com','taytaymont','2016-06-29 09:40:14','$2y$10$.UxeanGgzlrysBTKJ5/VQeErsbd8DNITzDnSedLKBK6hUbh3DiTe2'),
	(5,'Angela','Yang','angieyang@fb.com','angieyang','2016-06-30 10:46:49','$2y$10$5J/dd79Kn.yG5JoWuON2LeCsx29YPw.7gClaGeQZxHq0ESJ218RXK'),
	(16,'Barack','Obama','barackobama@fb.com','obama_out','2016-06-30 12:57:31','$2y$10$ashsFQZDr2YPre9UANF/yuPI17OTZ8xuX3bRLToXNLeHjSVv3tW/6'),
	(19,'Carmen','Tang','carmentang@berkeley.edu','carmentang','2016-06-30 13:06:12','$2y$10$oB8JwYPCba1QiGY4WBQOcuEHHJt3u1r9Q21swWo0K01bYSclkBf/K');
